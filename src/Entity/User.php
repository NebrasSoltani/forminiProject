...

{
    ...
    #[Assert\Choice(choices: ['google', 'github', 'linkedin'], message: 'OAuth provider invalide')]
...
public function setGoogleAuthenticatorEnabled(bool $googleAuthEnabled): static
