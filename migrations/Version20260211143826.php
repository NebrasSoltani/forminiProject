 ...
 */
final class Version20260211143826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participation_evenement (id INT AUTO_INCREMENT NOT NULL, date_participation DATETIME NOT NULL, user_id INT NOT NULL, evenement_id INT NOT NULL, INDEX IDX_65A14675A76ED395 (user_id), INDEX IDX_65A14675FD02F13 (evenement_id), UNIQUE INDEX user_evenement_unique (user_id, evenement_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE societe (id INT AUTO_INCREMENT NOT NULL, nom_societe VARCHAR(255) NOT NULL, secteur VARCHAR(100) DEFAULT NULL, description LONGTEXT DEFAULT NULL, adresse LONGTEXT DEFAULT NULL, site_web VARCHAR(255) DEFAULT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_19653DBDA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, telephone VARCHAR(8) NOT NULL, gouvernorat VARCHAR(255) DEFAULT NULL, date_naissance DATE NOT NULL, profession VARCHAR(100) DEFAULT NULL, niveau_etude VARCHAR(100) DEFAULT NULL, role_utilisateur VARCHAR(50) NOT NULL, photo VARCHAR(255) DEFAULT NULL, is_email_verified TINYINT DEFAULT 0 NOT NULL, email_verification_token VARCHAR(255) DEFAULT NULL, email_verification_token_expires_at DATETIME DEFAULT NULL, email_verified_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
